  ...
  return (
   <div className='mt-10 px-7 flex flex-col'>
    <div className='flex justify-between items-center p-4 text-xl font-bold'>
      ...
      <a href="/hospitals/add-patient" className=' text-xl border-2 border-cyan-500 rounded-md px-7 py-2 inline-block font-bold text-cyan-500 hover:bg-cyan-500 hover:text-white duration-200m'>
      Add Patient</a>
    </div>
        ...
        <tbody>
          <tr>
            ...
            <div className="space-x-2">
              <button
                 className="bg-cyan-500 p-2 rounded-md text-gray-700">
